    ...
    return (
      ...
      >
        ...
        <Form.Item label="Name" name="fullname">
          <Input type="text" placeholder="Enter your Full Name" ref={fullnameInputRef} required />
        </Form.Item>
        <Form.Item label="Email" name="email">
          <Input type="email" placeholder="Enter your Email Id" ref={emailInputRef} required />
        </Form.Item>
        <Form.Item label="Phone" name="phone">
          <Input type="phone" placeholder="Enter your Phone Number" ref={phoneInputRef} required />
        </Form.Item>
        ...
        <Form.Item label="Confirm Password" name="c_password">
          <Input type="password" placeholder="Re-Type your Password" ref={c_passwordInputRef} required />
        </Form.Item>
        <p>
